...
async def sudoers_list(client, message: Message):
    ...
    await message.reply_video(="https://telegra.ph/file/9deb97c59b1d281a48c7a.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("ᴘᴀʜʟᴇ 𝓬𝓸𝓭𝓮𝓻 ᴘᴀᴘᴀ sᴇ ᴘᴇʀᴍɪssɪᴏɴ ʟᴇʟᴏ😁💀", show_alert=True)
    else:
