...
SONG_DOWNLOAD_DURATION = int(getenv("SONG_DOWNLOAD_DURATION", "2500"))
SONG_DOWNLOAD_DURATION_LIMIT = int(getenv("SONG_DOWNLOAD_DURATION_LIMIT", "2500"))
